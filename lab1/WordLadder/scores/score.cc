...
const string student_program = "./WordLadder";

#if __x86_64__
const string default_program = "./WordLadder-Demo-64";
#else
const string default_program = "./WordLadder-Demo-32";
#endif
...
int runTest(string input) {
  ...
  cout<<"executing your program...\n";
  if(system(("cat " + input +  " | timeout 60 " + student_program + " > " + out ).c_str()) != 0)   { rmTemp();return 1;}
  cout<<"execiting demo program...\n";
  if(system(("cat " + input +  " | timeout 60 " + default_program + " > " + c_out ).c_str()) != 0)  {rmTemp();return 2;}
